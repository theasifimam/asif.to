...
export default function CheatsheetForm({ cheatsheetId }) {
  ...
  return (
    <AdminFormShell
      ...
      title={
        cheatsheetId ? "Edit cheatsheet article" : "Create cheatsheet article"
      }
      ...
      >
        <section className="space-y-1 min-w-0 w-full">
          <div className={formSectionClass}>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs leading-5 text-zinc-500">
                Every fenced code block automatically receives Copy and Play
          ...
          <div className={formSectionClass}>
            <h2 className="flex items-center gap-2 font-semibold text-zinc-900 dark:text-white">
              <FileText className="h-4 w-4 text-blue-500" /> Search metadata
            </h2>
            <div className="space-y-2">
          ...
          <div className={formSectionClass}>
            ...
            <p className="text-xs text-muted-foreground">
              Select courses to promote in the sidebar and bottom panel of this
              cheatsheet.
            </p>
        ...
        >
          <div className="rounded-2xl border border-blue-500/20 bg-blue-500/5 p-4 text-xs leading-5 text-zinc-600 dark:text-zinc-300">
            <strong className="block text-blue-600 dark:text-blue-400">
              Unified content model
            </strong>
            This entry is stored in the articles collection with type set to
            cheatsheet.
          </div>
          <div className="space-y-2">
