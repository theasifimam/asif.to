    ...
    items: [
      {
        ...
        description: "Customer messages & support inbox",
      },
      {
        name: "Campaigns",
        href: "/communications/campaigns",
        icon: Megaphone,
        permission: "communications.campaigns.read",
        description: "Email newsletters & broadcasts",
      },
      {
        name: "Subscribers",
        href: "/communications/subscribers",
        icon: UserCheck,
        permission: "communications.subscribers.read",
        description: "Audience & contact lists",
      },
      {
        name: "Automations",
        href: "/communications/automations",
        icon: Zap,
        permission: "communications.automations.manage",
        description: "Drip campaigns & autoresponders",
      },
      {
        name: "Transactional",
        href: "/communications/transactional",
        icon: Receipt,
        permission: "communications.transactional.read",
        description: "Receipts, resets & system emails",
      },
      {
        name: "Templates",
        ...
        description: "Email & message templates",
      },
      {
        name: "Team Chat",
        href: "/communications/team",
        icon: MessagesSquare,
      ...
      {
        name: "Discussions",
        href: "/communications/discussions",
        icon: MessageCircle,
        permission: "messages.view",
        description: "Public & course discussions",
      },
      {
        name: "Analytics",
        ...
        description: "Delivery & open rate reports",
      },
      {
        name: "Comm Settings",
        href: "/communications/settings",
        icon: Sliders,
        permission: "communications.settings.manage",
        description: "SMTP, domain & provider settings",
      },
    ],
  },
  {
