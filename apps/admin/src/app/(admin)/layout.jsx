  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Zap,
        permission: "job_sources.manage",
        description: "Automated company & source discovery",
      },
      {
        name: "Companies",
        href: "/jobs/companies",
    ...
    items: [
      {
        ...
        description: "Inbox, campaigns, subscribers & settings",
        children: [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          { name: "asif.to", href: "/site-settings" },
          { name: "admin.asif.to", href: "/site-settings/admin-brand" },
          { name: "SEO Settings", href: "/site-settings/seo" },
          { name: "Interlinking", href: "/site-settings/interlinking" },
          { name: "Code Playground", href: "/site-settings/playground" },
        ],
      },
      {
        name: "Admin Guide",
