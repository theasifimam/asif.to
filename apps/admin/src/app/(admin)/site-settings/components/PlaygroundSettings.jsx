  ...
  return (
    <div className="space-y-6 pb-12 text-zinc-900 dark:text-zinc-100">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full sm:w-fit rounded-2xl border border-zinc-200 bg-white p-2 shadow-sm dark:border-zinc-800 dark:bg-[#121215]">
          <button
            disabled={busy}
            onClick={() => save("draft")}
            className="flex-1 sm:flex-initial inline-flex h-9 items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white px-3.5 py-1.5 text-xs font-bold text-zinc-700 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-[#18181b] dark:text-zinc-300 dark:hover:bg-zinc-900 transition-colors cursor-pointer disabled:opacity-50"
          >
            <Save size={14} /> Draft
          </button>
          <button
      ...
      <section className="rounded-2xl border border-zinc-200/80 bg-white p-5 shadow-xs dark:border-zinc-800/80 dark:bg-[#121215]">
        ...
        <textarea
          className="mt-4 w-full rounded-xl border border-zinc-200 bg-white p-3 text-sm text-zinc-900 placeholder:text-zinc-400 outline-none focus-visible:border-blue-500 focus-visible:ring-2 focus-visible:ring-blue-500/10 dark:border-zinc-800 dark:bg-[#18181b] dark:text-zinc-100 dark:placeholder:text-zinc-500"
          rows="2"
              ...
              >
                ...
                <div className="md:col-span-4 mt-1">
                  <label className="flex flex-col gap-2 text-xs font-semibold cursor-pointer w-full">
                    ...
                    <textarea
                      className="w-full rounded-xl border border-zinc-200 bg-white p-3 text-xs text-zinc-900 placeholder:text-zinc-400 outline-none focus-visible:border-blue-500 focus-visible:ring-2 focus-visible:ring-blue-500/10 dark:border-zinc-800 dark:bg-[#18181b] dark:text-zinc-100 dark:placeholder:text-zinc-500 font-mono"
                      rows="3"
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2 md:grid-cols-4">
          {Object.entries(form.limits || {}).map(([key, value]) => (
            ...
            >
              {key}
              <input
                className="w-full rounded-xl border border-zinc-200 bg-white p-2.5 text-sm font-normal text-zinc-900 outline-none focus-visible:border-blue-500 dark:border-zinc-800 dark:bg-[#18181b] dark:text-zinc-100"
                type="number"
                value={value}
                onChange={(e) =>
                  set("limits", {
