...
export function TopicDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-120 border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-10 rounded-[40px] gap-8">
        ...
        <DialogHeader className="items-center text-center gap-3 sm:gap-4">
          ...
          <DialogDescription className="text-zinc-500 dark:text-zinc-400 text-xs sm:text-[13px] font-medium leading-relaxed">
            ...
            <strong className="text-zinc-900 dark:text-white">
              &ldquo;{selectedTopic?.name}&rdquo;
            </strong>
            ? This will remove it from all articles using it.
          </DialogDescription>
        </DialogHeader>
