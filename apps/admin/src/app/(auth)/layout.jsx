...
export default function AuthLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-foreground flex flex-col lg:flex-row items-center justify-center lg:gap-16 p-4 sm:p-8 lg:p-20 transition-colors duration-300 relative overflow-hidden font-sans">
      ...
      {/* Left Branding Panel featuring Random Motivational Quote as LARGEST TEXT */}
      <div className="hidden lg:flex lg:flex-col lg:w-[50%] max-w-2xl justify-center gap-8 relative z-10">
        ...
        >
          <p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 font-bold leading-relaxed max-w-xl">
            Centralized administrative command center and content orchestration engine for
            learning tracks, interactive articles, and platform settings.
          </p>
        </motion.div>
      </div>
