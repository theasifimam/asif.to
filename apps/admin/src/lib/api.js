...
export const coursesApi = {
  ...
  list: (params) => apiGet(`/courses?${params ? new URLSearchParams(params) : ""}`),
...
export const cheatsheetsApi = {
  list: (params) => apiGet(`/cheatsheets?${params ? new URLSearchParams(params) : "status=all"}`),
...
export const quizApi = {
  list: (params) => apiGet(`/quiz?${params ? new URLSearchParams(params) : ""}`),
  listAll: (techId) => apiGet(`/quiz/admin/all${techId ? `?techId=${techId}` : ""}`),
...
export const flashcardsApi = {
  list: (params) => apiGet(`/flashcards?${params ? new URLSearchParams(params) : ""}`),
  listAll: (techId) => apiGet(`/flashcards/admin/all${techId ? `?techId=${techId}` : ""}`),
