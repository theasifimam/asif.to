...
</div>`,content:["Tailwind CSS provides low-level utility classes for padding, margins, flexbox, grid, and typography.","Responsive breakpoints (`sm:`, `md:`, `lg:`, `xl:`) follow mobile-first design principles.","Dark mode is enabled by prefixing classes with `dark:` (e.g. `bg-white dark:bg-zinc-900`)."],tryItChallenge:"Create a 3-column responsive card layout that collapses to 1 column on mobile."}]}].flatMap(a=>a.chapters.map(b=>({id:b.id,techId:a.techId,title:b.title,summary:b.summary,level:a.level,readTime:"4 min read",updatedAt:"2026-08-09",author:"DevBytes Team",views:4200,likes:310,codeSnippet:b.codeSnippet,explanation:b.content,keyTakeaways:[`Master ${a.title} concepts.`,`Practice challenge: ${b.tryItChallenge}`]})));a.s(["REVISION_CARDS",0,b,"TECH_STACKS",0,[{id:"reactjs",name:"React.js",icon:"Code2",color:"from-cyan-500 to-blue-600",textColor:"text-cyan-500",badgeBg:"bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 font-bold",description:"JSX, Components, Hooks (useState, useEffect, useMemo), Context API & Performance",category:"Frontend Framework",totalLessons:7},{id:"nextjs",name:"Next.js",icon:"Zap",color:"from-zinc-900 to-black dark:from-zinc-100 dark:to-zinc-300",textColor:"text-zinc-900 dark:text-zinc-100",badgeBg:"bg-black text-white dark:bg-white dark:text-black font-bold",description:"App Router, Server Components, Routing, Server Actions & ISR/SSG Data Fetching",category:"Fullstack Framework",totalLessons:6},{id:"nodejs",name:"Node.js",icon:"Server",color:"from-emerald-600 to-green-700",textColor:"text-emerald-500",badgeBg:"bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 font-bold",description:"Event Loop, Async I/O, Modules, FS Module & HTTP Server Setup",category:"Backend Runtime",totalLessons:5},{id:"expressjs",name:"Express.js",icon:"Layers",color:"from-gray-700 to-zinc-900",textColor:"text-zinc-700 dark:text-zinc-300",badgeBg:"bg-zinc-800 text-white font-bold",description:"Routing, Custom Middleware, REST API Architecture, Error Handlers & Auth",category:"Backend Framework",totalLessons:5},{id:"mongodb",name:"MongoDB",icon:"Database",color:"from-emerald-500 to-teal-700",textColor:"text-emerald-600 dark:text-emerald-400",badgeBg:"bg-teal-500/10 text-teal-600 dark:text-teal-400 font-bold",description:"Documents, Collections, BSON, Aggregation Pipelines, Indexes & Mongoose ODM",category:"NoSQL Database",totalLessons:5},{id:"tailwindcss",name:"Tailwind CSS",icon:"Sparkles",color:"from-sky-400 to-cyan-500",textColor:"text-sky-500",badgeBg:"bg-sky-500/10 text-sky-600 dark:text-sky-400 font-bold",description:"Utility-First CSS, Flexbox & Grid, Responsive Breakpoints, Dark Mode & Animations",category:"CSS Framework",totalLessons:5},{id:"javascript",name:"JavaScript",icon:"FileCode",color:"from-amber-400 to-yellow-500",textColor:"text-amber-500",badgeBg:"bg-yellow-500/10 text-yellow-600 dark:text-yellow-400 font-bold",description:"ES6+ Syntax, Async/Await, Promises, Closures, Array Methods & DOM",category:"Programming Language",totalLessons:6},{id:"csharp",name:"C# & .NET",icon:"Code2",color:"from-violet-600 to-indigo-700",textColor:"text-violet-600 dark:text-violet-400",badgeBg:"bg-violet-500/10 text-violet-700 dark:text-violet-300 font-bold",description:"C# Fundamentals, OOP, LINQ, Async, EF Core, ASP.NET Core APIs, Testing & Docker",category:"Language & Backend Platform",totalLessons:24}],"TUTORIALS",0,c])},248434,a=>{"use strict";var b=a.i(572131);let c=["learn","revise","practice","build"],d={learn:40,revise:25,practice:25,build:10},e=a=>String(a?._id||a||"");function f(a){return{chapters:{}}}function g(a){return{...a,chapterMap:Object.fromEntries((a?.chapterProgress||[]).map(a=>[e(a.chapter?._id),a]))}}async function h(a,b={}){let c=await fetch(`${"https://api.asif.to/api/v1".replace(/\/$/,"")}${a}`,{...b,credentials:"include",cache:"no-store",headers:{"Content-Type":"application/json",...b.headers||{}}}),d=await c.json().catch(()=>({}));if(!c.ok){let a=Error(d?.message||"Request failed.");throw a.status=c.status,a}return d?.data||{}}async function i(a,b){let i=f(a,b);try{let b=await h(`/courses/${encodeURIComponent(a)}/progress`),c=Object.values(i.chapters||{});if(c.length)try{b=await h(`/courses/${encodeURIComponent(a)}/progress/merge`,{method:"POST",body:JSON.stringify({chapters:c})}),localStorage.removeItem(`asif_course_progress_${String(a||"").toLowerCase()}`),localStorage.removeItem(`course_completed_${String(a||"")}`)}catch{}return g({...b,source:"server"})}catch{return g(function(a,b=[]){let g=f(a,b),h=b.map(a=>{let b,f,h=e(a._id)||a.slug,i=g.chapters[h]||g.chapters[a.slug]||{},j=(b=a?.learningActivities?.build||{},{learn:!0,revise:Number((f=a?.learningAvailability||{}).reviseCount||0)>0,practice:Number(f.practiceCount||0)>0||!!String(a?.tryItChallenge||"").trim(),build:void 0!==f.build?!!f.build:!!(Array.isArray(a?.codingProblems)&&a.codingProblems.length||b.enabled&&(String(b.title||"").trim()||String(b.description||"").trim()))}),k={};for(let a of c){let b=i?.[a]||{};k[a]={completed:!!b.completed,score:Number(b.score||0),attempts:Number(b.attempts||0),completedAt:b.completedAt||null,percent:j[a]?stagePercent(a,b):0}}let l=c.filter(a=>j[a]),m=l.reduce((a,b)=>a+d[b],0),n=m?Math.round(l.reduce((a,b)=>a+k[b].percent*d[b],0)/m):0;return{chapter:{_id:a._id,slug:a.slug,title:a.title,summary:a.summary,order:a.order},availability:j,stages:k,masteryScore:n,lastActivityAt:i.lastActivityAt||null}}),i=h.length?Math.round(h.reduce((a,b)=>a+b.masteryScore,0)/h.length):0,j=a=>c.some(b=>a.availability[b]&&!satisfied(b,a.stages[b])),k=h.find(a=>e(a.chapter._id)===String(g.lastChapterId)&&j(a))||h.find(j),l=null;if(k){let b=c.find(a=>k.availability[a]&&!satisfied(a,k.stages[a]));b&&(l={stage:b,chapter:k.chapter,href:"learn"===b?`/${a}/${k.chapter.slug}`:`/${a}/${k.chapter.slug}/${b}`,label:"learn"===b?"Continue reading":"revise"===b?"Revise this chapter":"practice"===b?"Practice this chapter":"Build with this chapter"})}return{source:"local",overallProgress:i,completedChapters:h.filter(a=>satisfied("learn",a.stages.learn)).map(a=>a.chapter.slug),chapterProgress:h,nextAction:l}}(a,b))}}async function j({courseSlug:a,chapterId:b,chapterSlug:d,stage:e,completed:f,score:i,chapter:j}){let k=d||b;if(!a||!k||!c.includes(e))return null;try{let b=await h(`/courses/${encodeURIComponent(a)}/chapters/${encodeURIComponent(k)}/progress`,{method:"PATCH",body:JSON.stringify({stage:e,...void 0!==f?{completed:f}:{},...void 0!==i?{score:i}:{}})});return g({...b,source:"server"})}catch{return null}}function k(a,c=[]){let d=(0,b.useMemo)(()=>c||[],[c]),[e,f]=(0,b.useState)(()=>({...g({source:"local",overallProgress:0,completedChapters:[],chapterProgress:[],nextAction:null}),loading:!0})),h=(0,b.useCallback)(async()=>{a?f({...await i(a,d),loading:!1}):f(a=>({...a,loading:!1}))},[a,d]);(0,b.useEffect)(()=>{let a=window.setTimeout(h,0);return()=>window.clearTimeout(a)},[h]),(0,b.useEffect)(()=>{let b=b=>{b?.detail?.courseSlug&&b.detail.courseSlug!==a||h()};return window.addEventListener("asif-course-progress-updated",b),()=>window.removeEventListener("asif-course-progress-updated",b)},[a,h]);let l=(0,b.useCallback)(async(b,c,d={})=>{await j({courseSlug:a,chapterId:b?._id,chapterSlug:b?.slug,stage:c,chapter:b,...d}),await h()},[a,h]);return{...e,refresh:h,markStage:l}}a.s(["recordCourseStage",()=>j,"useCourseProgress",()=>k])}];

//# sourceMappingURL=lib_94da6aed._.js.map