...
}`,difficulty:"Beginner"},{id:"rc-3",techId:"mongodb",topic:"Mongoose Querying",title:"Select specific fields (Projection)",frontText:"How to fetch only `title` and `author` while excluding `_id` in Mongoose?",backText:"Use `.select('title author -_id')` or `.select({ title: 1, author: 1, _id: 0 })`",code:"const result = await Article.find().select('title author -_id');",difficulty:"Intermediate"}],r=[{id:"reactjs",title:"React.js Complete Course: Zero to Mastery",techId:"reactjs",subtitle:"Learn modern React with Hooks, JSX, Components, State, Context API and Performance Optimization.",level:"Beginner - Advanced",duration:"2.5 Hours",chapters:[{id:"ch-1-intro",title:"1. Introduction to React & JSX",summary:"What is React, Virtual DOM, and how JSX transforms HTML inside JavaScript.",codeSnippet:`import React from "react";
...
</div>`,content:["Tailwind CSS provides low-level utility classes for padding, margins, flexbox, grid, and typography.","Responsive breakpoints (`sm:`, `md:`, `lg:`, `xl:`) follow mobile-first design principles.","Dark mode is enabled by prefixing classes with `dark:` (e.g. `bg-white dark:bg-zinc-900`)."],tryItChallenge:"Create a 3-column responsive card layout that collapses to 1 column on mobile."}]}].flatMap(e=>e.chapters.map(t=>({id:t.id,techId:e.techId,title:t.title,summary:t.summary,level:e.level,readTime:"4 min read",updatedAt:"2026-08-09",author:"DevBytes Team",views:4200,likes:310,codeSnippet:t.codeSnippet,explanation:t.content,keyTakeaways:[`Master ${e.title} concepts.`,`Practice challenge: ${t.tryItChallenge}`]})));e.s(["REVISION_CARDS",0,t,"TECH_STACKS",0,[{id:"reactjs",name:"React.js",icon:"Code2",color:"from-cyan-500 to-blue-600",textColor:"text-cyan-500",badgeBg:"bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 font-bold",description:"JSX, Components, Hooks (useState, useEffect, useMemo), Context API & Performance",category:"Frontend Framework",totalLessons:7},{id:"nextjs",name:"Next.js",icon:"Zap",color:"from-zinc-900 to-black dark:from-zinc-100 dark:to-zinc-300",textColor:"text-zinc-900 dark:text-zinc-100",badgeBg:"bg-black text-white dark:bg-white dark:text-black font-bold",description:"App Router, Server Components, Routing, Server Actions & ISR/SSG Data Fetching",category:"Fullstack Framework",totalLessons:6},{id:"nodejs",name:"Node.js",icon:"Server",color:"from-emerald-600 to-green-700",textColor:"text-emerald-500",badgeBg:"bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 font-bold",description:"Event Loop, Async I/O, Modules, FS Module & HTTP Server Setup",category:"Backend Runtime",totalLessons:5},{id:"expressjs",name:"Express.js",icon:"Layers",color:"from-gray-700 to-zinc-900",textColor:"text-zinc-700 dark:text-zinc-300",badgeBg:"bg-zinc-800 text-white font-bold",description:"Routing, Custom Middleware, REST API Architecture, Error Handlers & Auth",category:"Backend Framework",totalLessons:5},{id:"mongodb",name:"MongoDB",icon:"Database",color:"from-emerald-500 to-teal-700",textColor:"text-emerald-600 dark:text-emerald-400",badgeBg:"bg-teal-500/10 text-teal-600 dark:text-teal-400 font-bold",description:"Documents, Collections, BSON, Aggregation Pipelines, Indexes & Mongoose ODM",category:"NoSQL Database",totalLessons:5},{id:"tailwindcss",name:"Tailwind CSS",icon:"Sparkles",color:"from-sky-400 to-cyan-500",textColor:"text-sky-500",badgeBg:"bg-sky-500/10 text-sky-600 dark:text-sky-400 font-bold",description:"Utility-First CSS, Flexbox & Grid, Responsive Breakpoints, Dark Mode & Animations",category:"CSS Framework",totalLessons:5},{id:"javascript",name:"JavaScript",icon:"FileCode",color:"from-amber-400 to-yellow-500",textColor:"text-amber-500",badgeBg:"bg-yellow-500/10 text-yellow-600 dark:text-yellow-400 font-bold",description:"ES6+ Syntax, Async/Await, Promises, Closures, Array Methods & DOM",category:"Programming Language",totalLessons:6},{id:"csharp",name:"C# & .NET",icon:"Code2",color:"from-violet-600 to-indigo-700",textColor:"text-violet-600 dark:text-violet-400",badgeBg:"bg-violet-500/10 text-violet-700 dark:text-violet-300 font-bold",description:"C# Fundamentals, OOP, LINQ, Async, EF Core, ASP.NET Core APIs, Testing & Docker",category:"Language & Backend Platform",totalLessons:24}],"TUTORIALS",0,r])},505533,e=>{"use strict";var t=e.i(843476),r=e.i(271645),s=e.i(522016),a=e.i(657688),n=e.i(972520),o=e.i(810980),i=e.i(32095),l=e.i(852008),d=e.i(555436),c=e.i(283086),u=e.i(595468),p=e.i(974875),m=e.i(690660),h=e.i(986687);let x={cardBg:"bg-blue-50/75 dark:bg-blue-950/25 hover:bg-blue-50 dark:hover:bg-blue-950/40",border:"border-blue-200/80 dark:border-blue-900/50 hover:border-blue-400 dark:hover:border-blue-500",badgeBg:"bg-blue-100/90 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 border-blue-200/80 dark:border-blue-800/50",titleHover:"group-hover:text-blue-600 dark:group-hover:text-blue-400",btn:"bg-blue-600 hover:bg-blue-700 text-white shadow-blue-500/20",iconColor:"text-blue-600 dark:text-blue-400"},f={reactjs:x,nextjs:x,javascript:x,typescript:x,css:x,nodejs:x,mongodb:x,expressjs:x,tailwindcss:x,default:x};function g({initialCourses:e=[]}){let[x,g]=(0,r.useState)(""),[b,y]=(0,r.useState)(""),v=(0,r.useMemo)(()=>{let t=e;if(x&&(t=t.filter(e=>e.techId?.toLowerCase()===x.toLowerCase()||e.slug?.toLowerCase().includes(x.toLowerCase()))),b.trim()){let e=b.trim().toLowerCase();t=t.filter(t=>t.title?.toLowerCase().includes(e)||t.description?.toLowerCase().includes(e)||t.subtitle?.toLowerCase().includes(e)||t.techId?.toLowerCase().includes(e))}return t},[e,x,b]),k=(0,r.useMemo)(()=>e.reduce((e,t)=>e+(t.chapterCount||t.chapters?.length||0),0),[e]);return(0,t.jsxs)("main",{className:"mx-auto w-full max-w-7xl px-4 pb-24 pt-20 sm:px-6 sm:pt-24 md:px-8",children:[(0,t.jsxs)("nav",{className:"mb-4 flex items-center gap-2 text-xs font-bold text-zinc-400",children:[(0,t.jsx)(s.default,{href:"/",className:"hover:text-blue-600 transition-colors",children:"Home"}),(0,t.jsx)("span",{children:"/"}),(0,t.jsx)("span",{className:"text-zinc-700 dark:text-zinc-200",children:"Courses"})]}),(0,t.jsxs)("div",{className:"scrollbar-none -mx-4 mb-5 flex items-center gap-1 overflow-x-auto px-4 py-1 sm:mx-0 sm:mb-7 sm:w-fit sm:rounded-full sm:border sm:border-zinc-200/80 sm:bg-white sm:p-1.5 sm:shadow-xs dark:sm:border-zinc-800 dark:sm:bg-zinc-900",children:[(0,t.jsxs)("div",{className:"flex min-h-11 shrink-0 items-center gap-2 px-4 rounded-full text-xs font-bold bg-blue-600 text-white shadow-md shadow-blue-500/20",children:[(0,t.jsx)(o.BookOpen,{className:"w-4 h-4"}),(0,t.jsx)("span",{children:"Courses"})]}),(0,t.jsxs)(s.default,{href:"/revision",className:"flex min-h-11 shrink-0 items-center gap-2 px-4 rounded-full text-xs font-bold text-zinc-600 dark:text-zinc-400 hover:text-foreground hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all",children:[(0,t.jsx)(l.Layers,{className:"w-4 h-4 text-purple-500"}),(0,t.jsx)("span",{children:"Flashcards Deck"})]}),(0,t.jsxs)(s.default,{href:"/quiz",className:"flex min-h-11 shrink-0 items-center gap-2 px-4 rounded-full text-xs font-bold text-zinc-600 dark:text-zinc-400 hover:text-foreground hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all",children:[(0,t.jsx)(p.HelpCircle,{className:"w-4 h-4 text-emerald-500"}),(0,t.jsx)("span",{children:"Practice Quiz"})]})]}),(0,t.jsx)("section",{className:"rounded-3xl sm:rounded-[2.5rem] border border-zinc-200/70 dark:border-zinc-800/70 bg-white dark:bg-zinc-900/90 p-5 sm:p-10 shadow-xs",children:(0,t.jsxs)("div",{className:"max-w-3xl",children:[(0,t.jsxs)("div",{className:"mb-4 inline-flex items-center gap-2 rounded-full bg-blue-50 px-3 py-1.5 text-xs font-bold text-blue-700 dark:bg-blue-950/40 dark:text-blue-300",children:[(0,t.jsx)(i.GraduationCap,{className:"h-3.5 w-3.5"}),(0,t.jsx)("span",{children:"Interactive Learning Tracks"})]}),(0,t.jsx)("h1",{className:"font-outfit text-2xl sm:text-4xl lg:text-5xl font-black tracking-tight text-zinc-950 dark:text-white leading-tight",children:"All Published Courses & Curriculum Roadmaps"}),(0,t.jsx)("p",{className:"mt-3 text-xs sm:text-sm font-medium leading-relaxed text-zinc-600 dark:text-zinc-400 max-w-2xl",children:"Master full-stack web development with structured hands-on courses. Every course features interactive code playgrounds, syntax guides, and real-world projects."}),(0,t.jsxs)("div",{className:"mt-5 flex flex-wrap items-center gap-2 pt-4 border-t border-zinc-100 dark:border-zinc-800/60 text-xs font-semibold text-zinc-500 dark:text-zinc-400",children:[(0,t.jsxs)("div",{className:"flex items-center gap-1.5 rounded-full bg-zinc-100 dark:bg-zinc-800 px-3 py-1 text-[11px] font-bold text-zinc-700 dark:text-zinc-300",children:[(0,t.jsx)(o.BookOpen,{className:"w-3.5 h-3.5 text-blue-500"}),(0,t.jsxs)("span",{children:[e.length," Published Courses"]})]}),(0,t.jsxs)("div",{className:"flex items-center gap-1.5 rounded-full bg-zinc-100 dark:bg-zinc-800 px-3 py-1 text-[11px] font-bold text-zinc-700 dark:text-zinc-300",children:[(0,t.jsx)(l.Layers,{className:"w-3.5 h-3.5 text-emerald-500"}),(0,t.jsxs)("span",{children:[k,"+ Interactive Lessons"]})]}),(0,t.jsxs)("div",{className:"flex items-center gap-1.5 rounded-full bg-zinc-100 dark:bg-zinc-800 px-3 py-1 text-[11px] font-bold text-zinc-700 dark:text-zinc-300",children:[(0,t.jsx)(c.Sparkles,{className:"w-3.5 h-3.5 text-amber-500"}),(0,t.jsx)("span",{children:"100% Free & Open Access"})]})]})]})}),(0,t.jsxs)("section",{className:"mt-6 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 sm:mt-8 sm:gap-4",children:[(0,t.jsxs)("div",{className:"relative flex-1 max-w-md",children:[(0,t.jsx)(d.Search,{className:"absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-400"}),(0,t.jsx)("input",{type:"text",placeholder:"Search courses by topic, framework, or title...",value:b,onChange:e=>y(e.target.value),className:"h-12 w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-full pl-11 pr-5 text-sm font-semibold text-zinc-900 dark:text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-blue-500/30 transition-all shadow-xs"})]}),(0,t.jsxs)("div",{className:"scrollbar-none -mx-4 flex items-center gap-2 overflow-x-auto px-4 pb-1 md:mx-0 md:px-0",children:[(0,t.jsx)("button",{onClick:()=>g(""),className:`min-h-11 shrink-0 px-4 rounded-full text-xs font-bold transition-all cursor-pointer ${""===x?"bg-blue-600 text-white shadow-sm":"bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-300 hover:border-blue-500"}`,children:"All Technologies"}),m.TECH_STACKS.map(e=>(0,t.jsx)("button",{onClick:()=>g(e.id),className:`flex min-h-11 shrink-0 items-center gap-1.5 px-3.5 rounded-full text-xs font-bold transition-all cursor-pointer ${x===e.id?"bg-blue-600 text-white shadow-sm":"bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-300 hover:border-blue-500"}`,children:(0,t.jsx)("span",{children:e.name})},e.id))]})]}),(0,t.jsx)("section",{className:"mt-6 sm:mt-8",children:v.length>0?(0,t.jsx)("div",{className:"grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3",children:v.map((e,r)=>{let l=e.slug||e.id||e._id,d=e.chapterCount??e.chapters?.length??0,c=f[e.techId?.toLowerCase()]||f.default;return(0,t.jsxs)("article",{className:`group relative flex flex-col justify-between overflow-hidden rounded-4xl sm:rounded-[2.5rem] border bg-linear-to-br from-blue-500/10 via-indigo-500/5 to-white dark:to-zinc-900/90 p-5 sm:p-6 shadow-xs hover:shadow-md transition-all hover:-translate-y-0.5 ${c.border}`,children:[(0,t.jsxs)("div",{children:[e.thumbnail?(0,t.jsx)(s.default,{href:`/courses/${l}`,className:"relative mb-3.5 block w-full overflow-hidden rounded-2xl bg-zinc-100 dark:bg-zinc-800/60 aspect-[2.1/1] border border-zinc-200/60 dark:border-zinc-800",children:(0,t.jsx)(a.default,{src:(0,h.getImageUrl)(e.thumbnail),alt:e.title,fill:!0,className:"object-cover transition-transform duration-500 group-hover:scale-103",unoptimized:!0})}):(0,t.jsx)(s.default,{href:`/courses/${l}`,className:"relative mb-3.5 flex w-full flex-col items-center justify-center overflow-hidden rounded-2xl bg-linear-to-br from-blue-500/10 via-cyan-500/5 to-white dark:to-zinc-900 aspect-[2.1/1] border border-blue-500/20 transition-all group-hover:border-blue-500/40",children:(0,t.jsxs)("div",{className:"relative z-10 flex flex-col items-center gap-1.5 p-3 text-center",children:[(0,t.jsx)("div",{className:"flex h-10 w-10 items-center justify-center rounded-2xl bg-blue-500/15 text-blue-600 dark:text-blue-400 border border-blue-500/20 group-hover:scale-105 transition-transform",children:(0,t.jsx)(i.GraduationCap,{className:"h-5 w-5"})}),(0,t.jsx)("span",{className:"font-outfit text-xs font-black tracking-tight text-zinc-900 dark:text-white line-clamp-1",children:e.title}),(0,t.jsx)("span",{className:"text-[9px] font-bold uppercase tracking-wider text-zinc-400",children:e.techId?.toUpperCase()||"DEVELOPER TRACK"})]})}),(0,t.jsxs)("div",{className:"flex items-center justify-between gap-2 mb-2.5",children:[(0,t.jsx)("span",{className:`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-[9.5px] font-black uppercase tracking-wider border ${c.badgeBg}`,children:e.techId?e.techId.toUpperCase():"DEVELOPER"}),(0,t.jsxs)("span",{className:"inline-flex items-center gap-1 text-[9.5px] font-bold text-emerald-700 dark:text-emerald-300 bg-emerald-500/15 px-2.5 py-0.5 rounded-full border border-emerald-500/20",children:[(0,t.jsx)(u.CheckCircle2,{className:"w-3 h-3 text-emerald-500"}),(0,t.jsx)("span",{children:"Online Track"})]})]}),(0,t.jsx)("h3",{className:`font-outfit text-base sm:text-lg font-black tracking-tight text-zinc-950 dark:text-white ${c.titleHover} transition-colors line-clamp-2 mt-2`,children:(0,t.jsx)(s.default,{href:`/courses/${l}`,children:e.title})}),(0,t.jsx)("p",{className:"mt-1.5 text-xs text-zinc-500 dark:text-zinc-400 font-medium leading-relaxed line-clamp-2",children:e.description||e.subtitle||`Master ${e.title} with step-by-step interactive lessons and syntax guides on asif.to.`})]}),(0,t.jsxs)("div",{className:"mt-5 pt-3 border-t border-zinc-200/60 dark:border-zinc-800/80 flex items-center justify-between gap-3",children:[(0,t.jsxs)("div",{className:"flex items-center gap-1.5 text-xs font-bold text-zinc-500 dark:text-zinc-400",children:[(0,t.jsx)(o.BookOpen,{className:`w-4 h-4 ${c.iconColor}`}),(0,t.jsxs)("span",{children:[d," Lessons"]})]}),(0,t.jsxs)(s.default,{href:`/courses/${l}`,className:`inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-xs font-bold shadow-xs transition-all active:scale-95 cursor-pointer ${c.btn}`,children:[(0,t.jsx)("span",{children:"Start Track"}),(0,t.jsx)(n.ArrowRight,{className:"w-3.5 h-3.5"})]})]})]},e._id||e.id||l)})}):(0,t.jsxs)("div",{className:"flex flex-col items-center justify-center py-20 px-4 text-center rounded-4xl border border-dashed border-zinc-300 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50",children:[(0,t.jsx)(o.BookOpen,{className:"w-12 h-12 text-zinc-400 mb-3"}),(0,t.jsx)("h3",{className:"text-lg font-bold font-outfit text-zinc-900 dark:text-white",children:"No Courses Found"}),(0,t.jsx)("p",{className:"text-xs text-zinc-500 max-w-sm mt-1",children:"No published courses matched your filter search criteria. Try clearing the search or selecting another technology."}),(0,t.jsx)("button",{onClick:()=>{y(""),g("")},className:"mt-5 px-5 py-2 rounded-full bg-blue-600 text-white text-xs font-bold hover:bg-blue-700 transition-all cursor-pointer",children:"Reset Filters"})]})})]})}e.s(["default",()=>g])},322716,e=>{e.v(t=>Promise.all(["static/chunks/e34f5cd4cfd69578.js"].map(t=>e.l(t))).then(()=>t(377023)))},216654,e=>{e.v(t=>Promise.all(["static/chunks/002a086ef08efd5f.js"].map(t=>e.l(t))).then(()=>t(548760)))}]);