  ...
  const quickLinks = [
    {
      ...
      description: "Step-by-step masterclasses with chapters, quizzes, and projects.",
      href: "/",
      icon: BookOpen,
      badge: "Curriculum",
      color: "from-blue-500/10 to-indigo-500/10 text-blue-600 dark:text-blue-400 border-blue-200/50 dark:border-blue-800/50",
      iconBg: "bg-blue-600 text-white",
    },
    {
      title: "Interview Questions",
      description: "Real-world technical questions, curated answers, and code examples.",
      href: "/interview-questions",
      icon: MessagesSquare,
      badge: "Interview Prep",
      color: "from-orange-500/10 to-amber-500/10 text-orange-600 dark:text-orange-400 border-orange-200/50 dark:border-orange-800/50",
    ...
    },
    {
      ...
      color: "from-purple-500/10 to-pink-500/10 text-purple-600 dark:text-purple-400 border-purple-200/50 dark:border-purple-800/50",
      iconBg: "bg-purple-600 text-white",
    },
    {
      title: "Technical Articles",
      description: "Deep dive explanations, tutorials, and practical architecture guides.",
      href: "/articles",
      icon: Sparkles,
      badge: "Articles",
      color: "from-emerald-500/10 to-teal-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-200/50 dark:border-emerald-800/50",
      iconBg: "bg-emerald-600 text-white",
    },
    {
      title: "Code Playground",
      description: "Test, prototype, and run JavaScript and web code snippets interactively.",
      href: "/playground",
      icon: Code2,
      badge: "Interactive",
      color: "from-cyan-500/10 to-sky-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-200/50 dark:border-cyan-800/50",
      iconBg: "bg-cyan-600 text-white",
    },
    {
      title: "Personal Library",
      description: "Access your saved notes, bookmarks, snippets, and collections.",
      href: "/library",
      icon: Bookmark,
      badge: "Saved",
      color: "from-rose-500/10 to-pink-500/10 text-rose-600 dark:text-rose-400 border-rose-200/50 dark:border-rose-800/50",
        ...
        <section className="relative overflow-hidden rounded-4xl sm:rounded-[3rem] bg-white dark:bg-zinc-900/90 border border-zinc-200/80 dark:border-zinc-800/80 p-6 sm:p-12 shadow-xl shadow-zinc-200/50 dark:shadow-black/40">
          ...
          <div className="relative z-10 flex flex-col items-center text-center max-w-2xl mx-auto">
            ...
            <p className="mt-4 text-sm sm:text-base font-medium text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-xl">
              The page or resource you are looking for might have been moved, renamed, or temporarily took a coffee break.
            </p>
            ...
            <div className="w-full mt-6 rounded-2xl bg-zinc-900 text-zinc-300 p-4 text-left font-mono text-xs border border-zinc-800 shadow-inner overflow-x-auto">
              <div className="flex items-center gap-2 mb-2 pb-2 border-b border-zinc-800 text-zinc-500">
                ...
                <span className="text-[11px] font-semibold">asif.to/router-diagnostics</span>
              </div>
              <p className="text-red-400">
                <span className="text-zinc-500">$</span> HTTP 404: ERR_RESOURCE_NOT_FOUND
              </p>
              <p className="text-zinc-400 mt-1">
                &gt; Resolution suggested: Try searching below or navigating to popular roadmaps.
              </p>
            </div>
