...
export default function PlaygroundPage() {
  return (
    <div className="min-h-screen bg-zinc-50 text-foreground dark:bg-zinc-950">
      <Header />
      <main className="mx-auto max-w-7xl px-3 pb-6 pt-20 sm:px-6 sm:pb-20 sm:pt-28">
        <header className="mb-5 sm:mb-7">
          ...
          <h1 className="mt-3 text-2xl font-black tracking-tight sm:text-4xl lg:text-5xl text-balance">
          ...
          <p className="mt-2 max-w-3xl text-xs sm:text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
            Practice loops, functions, components, methods, and algorithms in
            real time. Switch technologies directly in the editor header.
          </p>
