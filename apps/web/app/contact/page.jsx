        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          ...
          <div className="lg:col-span-5 flex flex-col gap-10">
            ...
            <p className="text-xl font-light text-zinc-500 leading-relaxed max-w-sm">
              For investigative leads, institutional licensing, or editorial
              inquiries. We prioritize secure communication.
            </p>
            ...
            <div className="flex flex-col gap-8 mt-10 font-sans">
              <div className="flex flex-col gap-2">
                ...
                <span className="text-sm font-bold border-b border-zinc-200 pb-1 w-fit hover:border-zinc-900 cursor-pointer transition-colors">
                  tips@asif.investigations
                </span>
              </div>
              <div className="flex flex-col gap-2">
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-zinc-400">
            ...
            <form className="flex flex-col gap-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="flex flex-col gap-4">
                  ...
                  <input
                    ...
                    className="border-b border-zinc-200 py-3 text-sm focus:outline-none focus:border-zinc-900 transition-colors bg-transparent placeholder:text-zinc-300"
                  />
                </div>
                <div className="flex flex-col gap-4">
                  <label className="text-[10px] font-bold uppercase tracking-[0.3em] text-zinc-400">
              ...
              <div className="flex flex-col gap-4">
                ...
                <textarea
                  ...
                  className="border-b border-zinc-200 py-3 text-sm focus:outline-none focus:border-zinc-900 transition-colors bg-transparent resize-none placeholder:text-zinc-300"
                ></textarea>
              </div>
