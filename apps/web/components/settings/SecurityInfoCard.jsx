...
export default function SecurityInfoCard() {
  return (
    <div className="p-5 mt-5 sm:p-6 rounded-3xl bg-white dark:bg-zinc-900/90 shadow-xs border border-zinc-100 dark:border-zinc-800/80 flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
      ...
      <div>
        ...
        <p className="text-xs text-zinc-500 font-medium leading-relaxed">
          ...
          (name, avatar, location, bio, and connected links) are displayed on
          your public profile.
        </p>
      </div>
    </div>
