...
export default function InterviewAnswer({ content }) {
  ...
  return <div className="w-full min-w-0 max-w-full space-y-4 break-words text-justify text-sm leading-7 text-zinc-700 [overflow-wrap:anywhere] dark:text-zinc-300 sm:text-[15px]">
