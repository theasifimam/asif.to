...
export default function AuthorIdentityCard({
  ...
  return (
    <aside
      className={`rounded-4xl border border-zinc-200/80 bg-white dark:border-zinc-800 dark:bg-zinc-900 ${compact ? "p-4" : "p-5 sm:p-6"}`}
      aria-label="About the author"
    >
      <div className="flex items-start gap-4">
        <Link
          href="/author/asif"
          className="relative grid h-12 w-12 shrink-0 place-items-center overflow-hidden rounded-2xl bg-blue-600 text-white"
        >
          {avatar ? (
            <Image
              src={assetUrl(avatar)}
        ...
        <div className="min-w-0 flex-1">
          ...
          <Link
            href="/author/asif"
            className="mt-1 inline-flex flex-wrap items-baseline gap-2 hover:text-blue-600"
          >
            <strong className="text-base">Asif</strong>
