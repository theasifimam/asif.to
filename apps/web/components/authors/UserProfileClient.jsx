                ...
                <div className="inline-flex items-center gap-1.5 p-1.5 rounded-2xl sm:rounded-full bg-zinc-200/60 dark:bg-zinc-900 text-xs font-bold shrink-0 min-w-full sm:min-w-0">
                  {tabs.map(({ key, label, icon: Icon }) => (
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-4 py-2.5 rounded-xl sm:rounded-full transition-all whitespace-nowrap text-xs font-bold ${
                        activeTab === key
                            ...
                            <div className="flex items-end justify-between gap-3">
                              <div className="flex flex-col items-start gap-2">
                                ...
                                <button
                                  ...
                                  className="inline-flex items-center gap-1.5 rounded-full bg-amber-600 px-3 py-2 text-xs font-bold text-white hover:bg-amber-700 disabled:cursor-not-allowed disabled:opacity-50"
                                >
                    ...
                    {quizAttempts.length ? (
                      <div className="space-y-3">
                        {[...quizAttempts].reverse().map((attempt) => (
                          ...
                          >
                            <div
                              className={`flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl text-lg font-black ${attempt.passed ? "bg-emerald-500/10 text-emerald-600" : "bg-red-500/10 text-red-500"}`}
                            >
                              {attempt.percentage}%
                            </div>
                      ...
                      <p className="rounded-3xl bg-white p-8 text-center text-sm text-zinc-500 dark:bg-zinc-900">
