...
export default function Footer({ containerWidth = "max-w-7xl" }) {
  ...
  return (
    <footer className="w-full mt-auto pt-8">
      ...
      >
        <div className="p-6 sm:p-10 rounded-4xl sm:rounded-[2.5rem] bg-white dark:bg-zinc-900/90 border border-zinc-200/80 dark:border-zinc-800/80 flex flex-col gap-8">
