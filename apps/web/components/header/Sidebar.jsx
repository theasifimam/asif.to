        ...
        <div className="fixed inset-0 z-200">
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-5 flex flex-col justify-between space-y-6">
                        ...
                        <Link
                          ...
                          className={`group flex items-center justify-between p-3.5 rounded-2xl transition-all duration-200 ${
                            isActive
                              ...
                              : "bg-zinc-50 dark:bg-zinc-800/40 hover:bg-zinc-100 dark:hover:bg-zinc-800/80 text-foreground border border-zinc-100 dark:border-zinc-800/50"
                          }`}
                        >
                          <div className="flex items-center gap-3">
                            <div
              ...
              {/* Quick Learning Tip */}
              <div className="p-4 rounded-3xl bg-blue-500/10 dark:bg-blue-500/15 border border-blue-500/20 text-xs space-y-1.5">
                <div className="flex items-center gap-2 font-bold text-blue-600 dark:text-blue-400">
                  <Sparkles className="w-4 h-4 shrink-0" />
                  <span>Interactive Learning</span>
                </div>
                <p className="text-zinc-600 dark:text-zinc-300 text-[11px] leading-relaxed font-medium">
                  Practice flashcards & bookmark code snippets to level up your
            ...
            <div className="p-5 bg-zinc-50 dark:bg-zinc-900/60 border-t border-zinc-100 dark:border-zinc-800/60">
              {!isInitialized ? (
                <div className="w-full h-12 rounded-2xl bg-zinc-200 dark:bg-zinc-800 animate-pulse" />
              ) : !isAuthenticated ? (
                <button
                  onClick={onSignInClick}
                  className="w-full py-3 rounded-2xl bg-blue-600 text-white text-xs font-bold shadow-md shadow-blue-500/20 hover:bg-blue-700 active:scale-95 transition-all"
                >
                ...
                <div className="flex items-center justify-between p-2.5 rounded-2xl bg-white dark:bg-zinc-800/80 border border-zinc-200/80 dark:border-zinc-700/60 shadow-sm">
                  ...
                  <button
                    ...
                    className="p-2 text-zinc-400 hover:text-red-500 transition-colors rounded-xl hover:bg-red-50 dark:hover:bg-red-950/40"
                    title="Sign Out"
                  >
                    <LogOut size={16} />
                  </button>
