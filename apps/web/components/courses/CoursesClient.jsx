...
const COURSE_CARD_THEMES = [
  ...
  {
    cardBg: "bg-purple-50/75 dark:bg-purple-950/25 hover:bg-purple-50 dark:hover:bg-purple-950/40",
    border: "border-purple-200/80 dark:border-purple-900/50 hover:border-purple-400 dark:hover:border-purple-500",
    badgeBg: "bg-purple-100/90 dark:bg-purple-500/20 text-purple-700 dark:text-purple-300 border-purple-200/80 dark:border-purple-800/50",
  ...
  {
    cardBg: "bg-rose-50/75 dark:bg-rose-950/25 hover:bg-rose-50 dark:hover:bg-rose-950/40",
    border: "border-rose-200/80 dark:border-rose-900/50 hover:border-rose-400 dark:hover:border-rose-500",
    badgeBg: "bg-rose-100/90 dark:bg-rose-500/20 text-rose-700 dark:text-rose-300 border-rose-200/80 dark:border-rose-800/50",
  ...
  {
    cardBg: "bg-teal-50/75 dark:bg-teal-950/25 hover:bg-teal-50 dark:hover:bg-teal-950/40",
    border: "border-teal-200/80 dark:border-teal-900/50 hover:border-teal-400 dark:hover:border-teal-500",
    badgeBg: "bg-teal-100/90 dark:bg-teal-500/20 text-teal-700 dark:text-teal-300 border-teal-200/80 dark:border-teal-800/50",
...
export default function CoursesClient({ initialCourses = [] }) {
  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-4 pb-24 pt-24 sm:px-6 md:px-8">
      {/* Hero Banner Section */}
      <section className="relative overflow-hidden rounded-4xl sm:rounded-[40px] border border-blue-500/20 bg-linear-to-br from-blue-600 via-indigo-700 to-zinc-950 p-8 sm:p-12 md:p-16 text-white shadow-2xl shadow-blue-600/20">
