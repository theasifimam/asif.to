export const BROWSER_RUNTIME_CONFIG = {
  ...
  cpp: { label: "C++", file: "/main.cpp", worker: "/workers/cpp-runtime.js", workerType: "classic", loading: "Loading C++ browser interpreter...", note: "C++ runs in the self-hosted browser interpreter loaded on demand." },
